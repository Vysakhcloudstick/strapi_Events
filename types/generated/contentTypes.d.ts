...
export interface ApiBookNowBookNow extends Struct.CollectionTypeSchema {
...
export interface ApiBusinessHourBusinessHour
  ...
  attributes: {
    businessHour: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCartDataCartData extends Struct.CollectionTypeSchema {
...
export interface ApiCategoryTabCategoryTab extends Struct.CollectionTypeSchema {
  collectionName: 'category_tabs';
  info: {
    displayName: 'categoryTab';
    pluralName: 'category-tabs';
    singularName: 'category-tab';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    categoryTab: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCheckoutCheckout extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    customerInformation: Schema.Attribute.Component<
      'shared.customer-i-nformation',
      false
    >;
    DeliveryOptions: Schema.Attribute.Component<
    ...
    OrderSummary: Schema.Attribute.Component<
      'shared.checkout-order-summary',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiConatctFloatingLabelConatctFloatingLabel
  extends Struct.CollectionTypeSchema {
  collectionName: 'conatct_floating_labels';
  info: {
    displayName: 'conatct floating label';
    pluralName: 'conatct-floating-labels';
    singularName: 'conatct-floating-label';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    CallUs: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    EmailUs: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::conatct-floating-label.conatct-floating-label'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiContactCardContactCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AddressCard: Schema.Attribute.RichText;
    CallUs: Schema.Attribute.BigInteger;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Email: Schema.Attribute.Email;
...
export interface ApiContactformContactform extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    companyNumber: Schema.Attribute.BigInteger;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    EmailAddress: Schema.Attribute.Email;
    eventType: Schema.Attribute.Text;
    ...
    preferredTime: Schema.Attribute.Time;
    publishedAt: Schema.Attribute.DateTime;
    tellUsAboutYourVision: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCopyRightUrlCopyRightUrl
  extends Struct.CollectionTypeSchema {
  collectionName: 'copy_right_urls';
  info: {
    displayName: 'copyRightUrl';
    pluralName: 'copy-right-urls';
    singularName: 'copy-right-url';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    copyRightUrl: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiEventPictureEventPicture
  extends Struct.CollectionTypeSchema {
  collectionName: 'event_pictures';
  info: {
    displayName: 'EventPicture';
    pluralName: 'event-pictures';
    singularName: 'event-picture';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-picture.event-picture'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiEventVideoEventVideo extends Struct.CollectionTypeSchema {
  collectionName: 'event_videos';
  info: {
    displayName: 'eventVideo';
...
export interface ApiFloatingCategoryFloatingCategory
  ...
  info: {
    displayName: 'floatingCategory';
    pluralName: 'floating-categories';
    singularName: 'floating-category';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    floatingCategory: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::floating-category.floating-category'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFooterContentFooterContent
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    footerIcons: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    FooterMainIcon: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiOrderReferenceCardOrderReferenceCard
  extends Struct.CollectionTypeSchema {
  collectionName: 'order_reference_cards';
  info: {
    displayName: 'Order Reference Card';
    pluralName: 'order-reference-cards';
    singularName: 'order-reference-card';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-reference-card.order-reference-card'
    > &
      Schema.Attribute.Private;
    OrderReference: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderSuccessAssistanceCardOrderSuccessAssistanceCard
  extends Struct.CollectionTypeSchema {
  collectionName: 'order_success_assistance_cards';
  info: {
    displayName: 'order Success Assistance card';
    pluralName: 'order-success-assistance-cards';
    singularName: 'order-success-assistance-card';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-success-assistance-card.order-success-assistance-card'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductCatgeoryProductCatgeory
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_catgeories';
  info: {
    displayName: 'productCatgeory';
    pluralName: 'product-catgeories';
    singularName: 'product-catgeory';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-catgeory.product-catgeory'
    > &
      Schema.Attribute.Private;
...
export interface ApiProductDetailProductDetail
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    descriptionFeatures: Schema.Attribute.RichText;
    detailDescription: Schema.Attribute.Text;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    ...
    quantity: Schema.Attribute.Integer;
    rating: Schema.Attribute.Decimal;
    rentalDetail: Schema.Attribute.RichText;
    RentalTerms: Schema.Attribute.RichText;
    review: Schema.Attribute.String;
...
export interface ApiWhatHappensNextSectionWhatHappensNextSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'what_happens_next_sections';
  info: {
    displayName: 'What Happens Next Section';
    pluralName: 'what-happens-next-sections';
    singularName: 'what-happens-next-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DeliverySetup: Schema.Attribute.Component<
      'shared.delivery-and-setup',
      false
    >;
    EmailConfirmation: Schema.Attribute.Component<
      'shared.email-confirmation',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::what-happens-next-section.what-happens-next-section'
    > &
      Schema.Attribute.Private;
    PersonalConsultation: Schema.Attribute.Component<
      'shared.personal-consultation',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
